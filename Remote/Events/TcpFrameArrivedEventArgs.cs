...
// Type: AsyncNet.Tcp.Remote.Events.TcpFrameArrivedEventArgs
namespace AsyncNetStandard.Tcp.Remote.Events
{
  ...
  {
    /// <summary>
    /// Creates <see cref="T:AsyncNet.Tcp.Remote.Events.TcpFrameArrivedEventArgs" /> with sender and frame data
    /// </summary>
